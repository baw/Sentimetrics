...
//my code
var mostPositiveUsers = dc.barChart('#positive-users-chart');

var projectId = 'gh28nlqqyc0om66wq6uyrc6eesjaiahn',
    user = 'jtsmith0107@gmail.com',
    passwd = 'georgeisathief';

// Report elements identifiers from which we execute a GD report - change to your specific metrics
var metric1 = 'atX10zFyeo9U',
    metric2 = 'awd1Ya19dHjD',
		attr1 = 'label.users.name';
...
var elements = [attr1, metric1, metric2];
...
gooddata.user.login(user, passwd).then(function() {
    ...
    var all = ndx.groupAll();
		...
		var positiveUsersDimension = ndx.dimension(function(d){
			return d.sentiment;
		});
		
		var positiveUsersGroup = positiveUsersDimension.group().reduceSum(function (d){
			debugger
		});
		...
		dc.dataTable(".dc-data-table")
		        .dimension(positiveUsersDimension)
